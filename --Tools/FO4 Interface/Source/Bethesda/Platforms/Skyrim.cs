...
namespace Bethesda.Platforms
{
	...
	{
		private const int SteamAppID = 72850;
		// TES5 Creation Kit ID 202480

		#region Windows

		public static string GetDocumentsPath()
		{
			string path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "My Games", "Skyrim");
