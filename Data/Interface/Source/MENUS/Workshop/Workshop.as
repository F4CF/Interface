	...
	public class Workshop extends IMenu
	{
		...
		public function set showIconCard(param1:Object) : *
		{
			...
			if(param1.assignedTo == undefined)
			{
				...
				_loc7_ = _loc7_ + (param1.powerRequired > 0 || param1.bpowerRequired?1:0);
				...
				switch(_loc7_)
				{
					...
					case 1:
						...
						this.IconCardBase_mc.RequirementIcons_mc.RequiresIcon1_mc.gotoAndStop(param1.powerRequired > 0 || param1.bpowerRequired?param1.powerRequired > 0?"Power":"PowerCentered":"People");
						GlobalFunc.SetText(this.IconCardBase_mc.RequirementIcons_mc.RequiresIcon1_mc.ResourceCount_tf,param1.powerRequired > 0 || param1.bpowerRequired?_loc8_:"",false);
						break;
					case 0:
				...
				while(_loc2_ < 2)
				{
					...
					if(_loc2_ < param1.length)
					{
						...
						if(param1[_loc2_].perkName != _loc3_.PerkName_tf.text)
						{
							...
							if(param1[_loc2_].swfName && param1[_loc2_].swfName.length > 0)
							{
		...
		public function SetItemIsNew(param1:uint) : *
		{
			...
			else
			{
				...
				{
					case 1:
						this.NewRecipeIcon_mc.gotoAndStop(1);
						break;
					case 2:
						this.NewRecipeIcon_mc.gotoAndStop(2);
						break;
					case 3:
						this.NewRecipeIcon_mc.gotoAndStop(3);
						break;
					case 4:
						this.NewRecipeIcon_mc.gotoAndStop(5);
						break;
					case 5:
						this.NewRecipeIcon_mc.gotoAndStop(6);
						break;
					case 6:
						this.NewRecipeIcon_mc.gotoAndStop(4);
						break;
		...
		public function SetButtonText(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean, param19:Boolean, param20:Boolean, param21:Boolean, param22:Boolean, param23:uint) : *
		{
			...
			else if(!param1 && !param2)
			{
				...
				{
					this.AButtonData.ButtonVisible = param6 || param7;
					this.AButtonData.ButtonEnabled = param6 || param7;
					if(param6)
					{
