package
{
	...
	public class SaveLoadPanel extends MovieClip
	{
		...
		public function set continueMode(param1:Boolean) : *
		{
			...
			if(param1 && this.List_mc.selectedEntry != null)
			{
		...
		public function onSaveLoadBatchComplete(param1:Boolean) : *
		{
			...
			{
				_loc3_ = "$[NEW SAVE]";
				if(this.bSaving && (this.List_mc.entryList.length == 0 || this.List_mc.entryList[0].text != _loc3_))
				{
					_loc4_ = {
						"name":" ",
						"text":_loc3_
			...
			if(param1 || this.List_mc.selectedIndex == -1)
			{
