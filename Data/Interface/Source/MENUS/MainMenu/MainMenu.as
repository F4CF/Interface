package
{
	...
	public class MainMenu extends IMenu
	{
		...
		public function InitList(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean = true, param6:Boolean = true, param7:* = false) : *
		{
			...
			if(!this.PauseMode && this.HasRecentSave)
			{
		...
		{
			return this.bRemapMode || this.bMenuClosing;
		}
		...
		{
			if(!this.bSavingSettings && this.BGSCodeObj.IsMainMenuReady())
			{
		...
		{
			if(this.MainPanel_mc.List_mc.selectedEntry.disabled || this.Spinner_mc.visible == true || this.bSettingsChanged)
			{
		...
		{
			if(this.strCurrentState == this.QUIT_CONFIRM_STATE && this.PauseMode && this.AllowQuitToDesktop)
			{
		...
		public function onListSelectionChange(param1:Event) : *
		{
			if(param1.target.selectedIndex != null && param1.target.selectedIndex != -1)
			{
				...
				if(this.strCurrentState == this.OPTIONS_LISTS_STATE && param1.target.entryList[param1.target.selectedIndex].guideText)
				{
		...
		private function UpdateButtons(param1:String) : *
		{
			switch(param1)
			{
				case this.MAIN_STATE:
					...
					this.YButton.ButtonVisible = !this.bSplashScreen && this.bShowChangeUserOption;
				...
				case this.QUIT_CONFIRM_STATE:
					this.VersionText_tf.visible = false;
					if(this.PauseMode && this.AllowQuitToDesktop)
					{
		...
		private function StartState(param1:String) : *
		{
			...
			if(this.GetPanelForState(param1) != null && _loc2_)
			{
		...
		public function onYButtonPressed() : Boolean
		{
			...
			else if(this.strCurrentState == this.QUIT_CONFIRM_STATE && this.PauseMode && this.AllowQuitToDesktop)
			{
				this.onQuitToDesktopPress();
				_loc1_ = true;
			}
			else if(this.strCurrentState == this.MAIN_STATE && !this.bSplashScreen && this.bShowChangeUserOption && this.YButton.ButtonVisible)
			{
				this.BGSCodeObj.ShowChangeUser();
				_loc1_ = true;
			}
			else if(this.strCurrentState == this.DLC_STATE && this.YButton.ButtonVisible)
			{
		...
		public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
		{
			...
			if(!_loc3_ && this.strCurrentState == this.HELP_STATE && param2 && stage.focus == this.HelpText)
			{
				switch(param1)
				{
					case "Up":
		...
		private function ShowDLCImage(param1:int) : *
		{
			...
			if(param1 > -1)
			{
				...
				this.ConfirmButton.ButtonVisible = uiPlatform != PlatformChangeEvent.PLATFORM_PS4 && uiPlatform != PlatformChangeEvent.PLATFORM_XB1 && !_loc2_ && _loc4_;
				...
				if(uiPlatform == PlatformChangeEvent.PLATFORM_PS4)
				{
					this.YButton.ButtonVisible = _loc3_ || _loc2_;
