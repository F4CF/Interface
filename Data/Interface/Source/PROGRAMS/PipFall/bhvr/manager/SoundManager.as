package bhvr.manager
{
	...
	public class SoundManager
	{
		...
		public function stopSound(soundId:uint, gamePaused:Boolean = false) : void
		{
			var playingSoundId:uint = 0;
			BGSExternalInterface.call(this.BGSCodeObj,"stopRegisteredSound",soundId);
			Log.info("SoundManager::stopSound: " + soundId);
			if(!gamePaused)
			{
				playingSoundId = this.getPlayingSoundIdFromRegisterId(soundId);
