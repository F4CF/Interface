package bhvr.controller
{
	...
	public class GameController
	{
		...
		private function initialize() : void
		{
			...
			SoundManager.instance.registerSound(SoundList.START_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.INTRO_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.POWER_ARMOR_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.LOSE_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.FINALE_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.STAGE_GENERIC_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.STAGE_2_MUSIC_LOOP_SOUND);
		}
