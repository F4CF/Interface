package
{
	...
	public class BookMenu extends IMenu
	{
		...
		public function BookMenu()
		{
			...
			{
				trace("[Book.swf]](CTOR) "+error.toString());
			}
		}

		public function set language(param1:String) : *
		{
			trace("[Book.swf]](language)");
			try
			{
			...
			{
				trace("[Book.swf]](language) "+error.toString());
			}
		}

		private function PopulateButtonBar() : void
		{
			trace("[Book.swf]](PopulateButtonBar)");
			try
			{
			...
			{
				trace("[Book.swf]](PopulateButtonBar) "+error.toString());
			}
		}

		private function onPrevButton() : void
		{
			trace("[Book.swf]](onPrevButton)");
		}

		private function onTakeButton() : void
		{
			trace("[Book.swf]](onTakeButton)");
		}

		private function onNextButton() : void
		{
			trace("[Book.swf]](onNextButton)");
		}

		private function onBackButton() : void
		{
			trace("[Book.swf]](onBackButton)");
		}

		public function SetTextOffset(param1:Number, param2:Number) : *
		{
			trace("[Book.swf]](SetTextOffset)");
			try
			{
			...
			{
				trace("[Book.swf]](SetTextOffset) "+error.toString());
			}
		}

		public function SetBookText(param1:String, param2:Boolean) : void
		{
			trace("[Book.swf]](SetBookText)");
			try
			{
				this.bNote = param2;
			...
			{
				trace("[Book.swf]](SetBookText) "+error.toString());
			}
		}

		private function CreateDisplayPage(param1:Number) : *
		{
			trace("[Book.swf]](CreateDisplayPage)");
			try
			{
				var _loc4_:int = 0;
				var _loc5_:int = 0;
			...
			{
				trace("[Book.swf]](CreateDisplayPage) "+error.toString());
			}
		}

		public function SetButtonVisibility(param1:int, param2:int, param3:int) : void
		{
			trace("[Book.swf]](SetButtonVisibility)");
			try
			{
				if(param1 > 0)
				{
			...
			{
				trace("[Book.swf]](SetButtonVisibility) "+error.toString());
			}
		}

		private function CalculatePagination() : void
		{
			trace("[Book.swf]](CalculatePagination)");
			try
			{
			...
			{
				trace("[Book.swf]](CalculatePagination) "+error.toString());
			}
		}

		private function SetLeftPageNumber(param1:Number) : void
		{
			trace("[Book.swf]](SetLeftPageNumber)");
			try
			{
				if(param1 < this.PageInfoA.length)
				{
			...
			{
				trace("[Book.swf]](SetLeftPageNumber) "+error.toString());
			}
		}

		public function ShowPageAtOffset(param1:Number) : void
		{
			trace("[Book.swf]](ShowPageAtOffset)");
			try
			{
				var _loc2_:Number = 0;
			...
			{
				trace("[Book.swf]](ShowPageAtOffset) "+error.toString());
			}
		}

		public function PrepForClose() : *
		{
			trace("[Book.swf]](PrepForClose)");
			try
			{
			...
			{
				trace("[Book.swf]](PrepForClose) "+error.toString());
			}
		}

		public function TurnPage(param1:Number) : Boolean
		{
			trace("[Book.swf]](TurnPage)");
			...
			{
				trace("[Book.swf]](TurnPage) "+error.toString());
			}
		...
		public function UpdatePages() : *
		{
			...
			{
				trace("[Book.swf]](UpdatePages) "+error.toString());
			}
		}

		function __setProp_ButtonHintBar_mc_Scene1_ButtonHintBar_mc_0() : *
		{
			trace("[Book.swf]](__setProp_ButtonHintBar_mc_Scene1_ButtonHintBar_mc_0)");
			try
			{
