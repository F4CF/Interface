package
{
	...
	public class LooksMenuOptionStepper extends MovieClip
	{
		...
		{
			GlobalFunc.SetText(this.LeftIcon_tf,this.Buttons == TRIGGERS?this.Platform == PlatformChangeEvent.PLATFORM_PC_GAMEPAD || PlatformChangeEvent.PLATFORM_XB1?"Y":"y":this.Platform == PlatformChangeEvent.PLATFORM_PC_GAMEPAD || PlatformChangeEvent.PLATFORM_XB1?"G":"g",false);
			GlobalFunc.SetText(this.RightIcon_tf,this.Buttons == TRIGGERS?this.Platform == PlatformChangeEvent.PLATFORM_PC_GAMEPAD || PlatformChangeEvent.PLATFORM_XB1?"X":"x":this.Platform == PlatformChangeEvent.PLATFORM_PC_GAMEPAD || PlatformChangeEvent.PLATFORM_XB1?"L":"m",false);
		}
