package
{
   ...
   public dynamic class BarterMenu extends ContainerMenu
   {
      ...
      override protected function UpdateButtonHints() : void
      {
         ...
         var _loc2_:Boolean = Boolean(_loc1_) || Boolean(MessageBoxIsActive);
         ...
         SwitchToPlayerButton.ButtonEnabled = stage.focus == ContainerList_mc && Boolean(PlayerInventory_mc.PlayerList_mc.itemsShown);
         SwitchToContainerButton.ButtonEnabled = stage.focus == PlayerInventory_mc.PlayerList_mc && Boolean(ContainerList_mc.itemsShown);
