package
{
   ...
   public class LooksMenu extends IMenu
   {
      ...
      {
         if(this.eMode == this.START_MODE && (this.EditMode == this.EDIT_CHARGEN || this.EditMode == this.EDIT_BODYMOD) && Boolean(this.BGSCodeObj.StartBodyEdit()))
         {
      ...
      public function SculptMode() : *
      {
         ...
         var _loc3_:uint = 0;
         if(Boolean(this.buttonHint_FaceMode_Sculpt.ButtonEnabled) && (this.EditMode == this.EDIT_CHARGEN || this.EditMode == this.EDIT_BODYMOD))
         {
      ...
      {
         if(Boolean(this.buttonHint_HairMode_Style.ButtonEnabled) && this.eMode == this.HAIR_MODE)
         {
            this.FeatureMode(this.AST_HAIR);
         }
      }
         ...
         switch(this.eFeature)
         {
            ...
            case this.AST_EXTRAS:
               if(this.CurrentExtraNumColors > 1)
               {
                  ...
                  if(Boolean(this._BumperJustPressed) || this._BumperDurationHeld - this.LastColorChangeAt > _loc8_)
                  {
                     if(Boolean(param1) && this.CurrentExtraColor > 0 || !param1 && this.CurrentExtraColor < this.CurrentExtraNumColors - 1)
                     {
                        if(param1)
                        {
      ...
      {
         if(Boolean(visible) && !this.confirmClose && this.InputFunctionsA[this.eMode][this.getInput(param1.keyCode)] != null)
         {
      ...
      private function onWeightTriangleChange(param1:MouseEvent) : void
      {
         ...
         if(Boolean(param1.buttonDown) && this.eMode == this.BODY_MODE)
         {
      ...
      public function UpdateButtons() : *
      {
         ...
         this.buttonHint_StartMode_Preset.ButtonVisible = Boolean(this.bInitialized) && (this.eMode == this.START_MODE && this.EditMode == this.EDIT_CHARGEN);
         this.buttonHint_StartMode_Preset.ButtonVisible = Boolean(this.bInitialized) && (this.eMode == this.START_MODE && this.EditMode == this.EDIT_CHARGEN);
         this.buttonHint_StartMode_Face.ButtonVisible = Boolean(this.bInitialized) && this.eMode == this.START_MODE && (this.EditMode == this.EDIT_CHARGEN || this.EditMode == this.EDIT_BODYMOD);
         this.buttonHint_StartMode_Extras.ButtonVisible = Boolean(this.bInitialized) && this.eMode == this.START_MODE && (this.EditMode == this.EDIT_CHARGEN || this.EditMode == this.EDIT_BODYMOD);
         this.buttonHint_StartMode_Sex.ButtonVisible = Boolean(this.bInitialized) && (this.eMode == this.START_MODE && this.EditMode == this.EDIT_CHARGEN && Boolean(this.AllowChangeSex));
         this.buttonHint_StartMode_Body.ButtonVisible = Boolean(this.bInitialized) && this.eMode == this.START_MODE && (this.EditMode == this.EDIT_CHARGEN || this.EditMode == this.EDIT_BODYMOD);
         this.buttonHint_StartMode_Done.ButtonVisible = Boolean(this.bInitialized) && (this.eMode == this.START_MODE || this.eMode == this.HAIR_MODE && this.EditMode == this.EDIT_HAIRCUT);
         ...
         this.buttonHint_SculptMode_Move.ButtonVisible = this.eMode == this.SCULPT_MODE && (Boolean(this.GetValidAxis(this.X_AXIS)) || Boolean(this.GetValidAxis(this.Y_AXIS)));
         this.buttonHint_SculptMode_Slide.ButtonVisible = this.eMode == this.SCULPT_MODE && Boolean(this.GetValidAxis(this.Z_AXIS));
         this.buttonHint_SculptMode_Rotate.ButtonVisible = this.eMode == this.SCULPT_MODE && Boolean(this.GetValidAxis(this.X_ROT_AXIS));
         this.buttonHint_SculptMode_Scale.ButtonVisible = this.eMode == this.SCULPT_MODE && Boolean(this.GetValidAxis(this.X_SCALE_AXIS));
