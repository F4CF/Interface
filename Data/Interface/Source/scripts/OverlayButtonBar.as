package
{
	...
	public class OverlayButtonBar extends ButtonBar
	{
		...
		override protected function setupRenderer(aButton:Button, param2:uint) : void
		{
			super.setupRenderer(aButton, param2);
			aButton.height = this._buttonHeight > 0?Number(this._buttonHeight):Number(aButton.actualHeight);
		}
		...
		public function ButtonCallback(e:ButtonEvent) : *
		{
