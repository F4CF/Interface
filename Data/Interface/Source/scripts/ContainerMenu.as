package
{
   ...
   public class ContainerMenu extends IMenu
   {
      ...
      protected function UpdateButtonHints() : void
      {
         ...
         var modalMenuIsActive:Boolean = Boolean(quantityMenuIsActive) || Boolean(this.MessageBoxIsActive);
         this.SwitchToPlayerButton.ButtonVisible = stage.focus == this.ContainerList_mc && Boolean(this.PlayerInventory_mc.PlayerList_mc.itemsShown) && uiPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE;
         this.SwitchToContainerButton.ButtonVisible = stage.focus == this.PlayerInventory_mc.PlayerList_mc && Boolean(this.ContainerList_mc.itemsShown) && uiPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE;
         this.EquipOrStoreButton.ButtonVisible = this.uiMode == CM_TEAMMATE && stage.focus != this.PlayerInventory_mc.PlayerList_mc;
         if(Boolean(this.EquipOrStoreButton.ButtonVisible) && !modalMenuIsActive)
         {
         ...
         this.EquipOrStoreButton.ButtonVisible = Boolean(this.EquipOrStoreButton.ButtonVisible) && !modalMenuIsActive;
      ...
      private function UpdateItemDisplay(TargetItemList:ItemList, aPlaySound:Boolean = true) : *
      {
         ...
         if(TargetItemList != null)
         {
            ...
            if(Boolean(this.PlayFocusSounds) && Boolean(aPlaySound))
            {
      ...
      {
         if(Boolean(visible) && this.uiMode != CM_JUNK_JET_RELOAD && !event.isDefaultPrevented() && !this.QuantityMenu_mc.opened)
         {
      ...
      private function changeItemFilter(arItemList:ItemList, aiDelta:int) : *
      {
         ...
         while(uinewFilter != uiprevFilter && Boolean(arItemList.filterer.IsFilterEmpty(this.FilterInfoA[uinewFilter].flag)));
      ...
      private function onListHeaderClick(event:Event) : *
      {
         ...
         if(Boolean(visible) && !this.QuantityMenu_mc.opened)
         {
      ...
      public function ProcessUserEvent(strEventName:String, abPressed:Boolean) : Boolean
      {
         ...
         if(Boolean(visible) && !abPressed)
         {
            if(strEventName == "Cancel" && Boolean(this.QuantityMenu_mc.opened))
            {
               this.CloseQuantityMenu();
               bhandled = true;
            }
