package
{
   ...
   public class VATSMenu extends IMenu
   {
         ...
         for(var adjustmentIter:uint = 0; adjustmentIter < numAdjustments; adjustmentIter++)
         {
            for(i = 1; i < this.PartInfos.length; i++)
            {
               if(this.PartInfos[i].visible)
               {
                  ...
                  {
                     if(i != compareIndex && Boolean(this.PartInfos[compareIndex].visible))
                     {
      ...
      {
         this.SelectButton.ButtonVisible = Boolean(this.bShowButtonHelp) && !this.bShowPlaybackButtons;
         this.AcceptButton.ButtonVisible = Boolean(this.bShowButtonHelp) && !this.bShowPlaybackButtons;
         this.CancelButton.ButtonVisible = Boolean(this.bShowButtonHelp) && !this.bShowPlaybackButtons;
         this.BodyPartButton.ButtonVisible = Boolean(this.bShowButtonHelp) && !this.bShowPlaybackButtons && this.PartInfos.length > 1;
         this.CycleTargetsButton.ButtonVisible = Boolean(this.bShowButtonHelp) && !this.bShowPlaybackButtons;
         this.ExecuteCriticalButton.ButtonVisible = Boolean(this.bShowButtonHelp) && Boolean(this.bShowPlaybackButtons);
         this.CancelPlaybackButton.ButtonVisible = Boolean(this.bShowButtonHelp) && Boolean(this.bShowPlaybackButtons);
      }
