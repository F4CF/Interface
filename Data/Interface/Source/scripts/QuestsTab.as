package
{
   ...
   public class QuestsTab extends PipboyTab
   {
      ...
      override public function redrawUIComponent() : void
      {
         ...
         this.ShowOnMapButton.ButtonVisible = Boolean(this.visible) && this.QuestsList_mc.selectedEntry != null;
         ...
         this.ShowOnMapButton.ButtonEnabled = _loc4_ != null && Boolean(_loc4_.enabled) && (Boolean(_loc4_.active) || Boolean(_loc3_)) && _loc4_.formID != 0;
         this.ShowSummaryButton.ButtonVisible = Boolean(this.visible) && this._DescText.length > 0;
         this.NavigateObjectivesButton.ButtonVisible = this.NavigateObjectivesButton.ButtonEnabled = Boolean(this.visible) && iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && iPlatform != PlatformChangeEvent.PLATFORM_MOBILE && this.QuestsList_mc.selectedEntry.formID == 0;
         this.ToggleActiveButton.ButtonVisible = Boolean(this.visible) && _loc4_ != null && iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && iPlatform != PlatformChangeEvent.PLATFORM_MOBILE;
         this.ToggleActiveButton.ButtonEnabled = Boolean(this.ToggleActiveButton.ButtonVisible) && Boolean(_loc4_.enabled);
      }
      ...
      {
         if(param1.target.getChildAt(0).currentFrame == param1.target.getChildAt(0).totalFrames)
         {
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(param1 == "XButton" && Boolean(this.ShowOnMapButton.ButtonVisible) && Boolean(this.ShowOnMapButton.ButtonEnabled) && !param2)
         {
            this.onShowOnMap();
            _loc3_ = true;
         }
         else if(param1 == "LShoulder" && Boolean(this.ShowSummaryButton.ButtonVisible) && !param2)
         {
            this.onShowSummary();
            _loc3_ = true;
         }
      ...
      private function onShowOnMap() : *
      {
         if(this.QuestsList_mc.selectedIndex != -1)
         {
            if(Boolean(this._ObjectivesListActive) && !this.ObjectivesList_mc.selectedEntry.active || !this._ObjectivesListActive && !this.QuestsList_mc.selectedEntry.active)
            {
               this.onQuestPress();
            }
