package
{
   ...
   public class Pipboy_MapPage extends PipboyPage
   {
      ...
      override protected function onReadOnlyChanged(param1:Boolean) : void
      {
         ...
         if(Boolean(param1) && Boolean(this.showingMessage))
         {
            this.CloseMessage();
         }
      }
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         else if(param1 == "XButton" && Boolean(this.LWToggleButton.ButtonVisible) && !param2)
         {
            this.onXButtonClicked();
         }
         else if(param1 == "LShoulder" && Boolean(this.ViewCaravansButton.ButtonVisible) && !param2)
         {
            this.onViewCaravans();
            _loc3_ = true;
         }
      ...
      private function UpdateCaravansButton() : *
      {
         ...
         this.ViewCaravansButton.ButtonVisible = Boolean(this.WorldMapHolder_mc.hasCaravans) && true;
      }
