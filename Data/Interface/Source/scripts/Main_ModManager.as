   ...
   public class Main_ModManager extends ISubmenu
   {
      ...
      public function onInitDataComplete() : *
      {
         ...
         if(this._MinimalMode)
         {
            ...
            {
               if(maxFramesToWait == 0 || Boolean(LibraryPage_mc.CheckThumbnailsLoaded()))
               {
                  FinishInit();
         ...
         else
         {
            ...
            {
               if(maxFramesToWait == 0 || Boolean(ListsHolder_mc.List1_mc.CheckScreenshotsLoaded()) && Boolean(ListsHolder_mc.List2_mc.CheckScreenshotsLoaded()))
               {
                  FinishInit();
      ...
      private function onKeyDown(param1:KeyboardEvent) : *
      {
         if(this.ListsHolder_mc.visible)
         {
            ...
            if(stage.focus is ModCategoryList)
            {
               ...
               else if(param1.keyCode == Keyboard.HOME && Boolean(this.Mod_TimeFilterButton.ButtonVisible))
               {
                  this.onTimeFilterLeftPress();
               }
               else if(param1.keyCode == Keyboard.END && Boolean(this.Mod_TimeFilterButton.ButtonVisible))
               {
      ...
      private function onModItemPress() : *
      {
         ...
         if(Boolean(this.ListsHolder_mc.visible) && this._StoredSelectedEntry != null)
         {
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!_loc3_ && this.LoginLoader_mc.content is ISubmenu && Boolean(this.LoginHolder_mc.visible))
         {
         ...
         if(!_loc3_ && !param2)
         {
            switch(param1)
            {
               ...
               case "XButton":
                  ...
                  break;
               case "LShoulder":
                  if(this.iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && Boolean(this.ListsHolder_mc.visible) && stage.focus is ModCategoryList)
                  {
                     (stage.focus as ModCategoryList).JumpLeft();
                  }
                  _loc3_ = true;
               ...
               case "RShoulder":
                  ...
                  break;
               case "LTrigger":
                  if(Boolean(this.Mod_TimeFilterButton.ButtonVisible) && this.iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && Boolean(this.ListsHolder_mc.visible) && stage.focus is ModCategoryList)
                  {
                     this.onTimeFilterLeftPress();
                  }
                  _loc3_ = true;
      ...
      private function onLibraryItemPress() : *
      {
         if(!this._MinimalMode && this.LibraryPage_mc.List_mc.selectedEntry != null)
         {
            ...
            {
               if(this.LibraryPage_mc.List_mc.selectedEntry.dataObj is Object)
               {
      ...
      private function UpdateButtons() : *
      {
         ...
         this.Mod_ConfirmButton.ButtonVisible = Boolean(this.DetailsPage_mc.visible) || Boolean(this.SearchPage_mc.visible);
         ...
         this.Mod_AccountSettingsButton.ButtonVisible = Boolean(this.LibraryPage_mc.visible) && !this.LibraryPage_mc.reorderMode && !this._MinimalMode;
         this.Mod_LibraryEnableButton.ButtonVisible = Boolean(this.LibraryPage_mc.visible) && !this.LibraryPage_mc.reorderMode && this.LibraryPage_mc.List_mc.itemsShown > 0 && !this._MinimalMode;
         this.Mod_LibraryDeleteButton.ButtonVisible = Boolean(this.LibraryPage_mc.visible) && !this.LibraryPage_mc.reorderMode && this.LibraryPage_mc.List_mc.itemsShown > 0 && !this._MinimalMode;
         this.Mod_ReorderButton.ButtonVisible = Boolean(this.LibraryPage_mc.visible) && this.LibraryPage_mc.List_mc.itemsShown > 0 && !this._MinimalMode;
