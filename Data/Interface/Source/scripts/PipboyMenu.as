package
{
   ...
   public class PipboyMenu extends IMenu
   {
      ...
      public function InvalidatePartialData(param1:uint) : *
      {
         if(!this._IsLoadingPage)
         {
            ...
            else
            {
               ...
               this.GridViewButton.ButtonVisible = this.CurrentPage == null || Boolean(this.CurrentPage.CanLowerPipboy());
            }
         }
      }
      ...
      {
         var _loc3_:Boolean = this.CurrentPage != null && Boolean(this.CurrentPage.ProcessUserEvent(param1,param2));
         if(!_loc3_)
         {
            if(!param2)
            {
               ...
               if(param1 == "YButton" && Boolean(this.GridViewButton.ButtonVisible))
               {
      ...
      {
         if(param1 < this.PageA.length && this.CurrentPage != null && Boolean(this.CurrentPage.CanSwitchFromCurrentPage()))
         {
      ...
      {
         if(this.CurrentPage != null && Boolean(this.CurrentPage.CanSwitchTabs(param1)))
         {
