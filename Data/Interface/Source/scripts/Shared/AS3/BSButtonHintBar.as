package Shared.AS3
{
   ...
   public dynamic class BSButtonHintBar extends BSUIComponent
   {
      ...
      override public function redrawUIComponent() : void
      {
         ...
         if(Boolean(this.ShadedBackground_mc) && Boolean(contains(this.ShadedBackground_mc)))
         {
         ...
         while(_loc4_ < this.ButtonPoolV.length)
         {
            ...
            if(Boolean(_loc6_.ButtonVisible) && Boolean(this.CanBeVisible()))
            {
               _loc1_ = true;
               ...
               if(Boolean(CompanionAppMode.isOn) && _loc6_.Justification == Shared.AS3.BSButtonHint.JUSTIFY_RIGHT)
               {
         ...
         this.ButtonBracket_Left_mc.visible = Boolean(this.bShowBrackets) && !CompanionAppMode.isOn;
         this.ButtonBracket_Right_mc.visible = Boolean(this.bShowBrackets) && !CompanionAppMode.isOn;
         if(ShadedBackgroundMethod == "Flash" && Boolean(this.bUseShadedBackground))
         {
