package Shared.AS3
{
   ...
   public class BSScrollingList extends MovieClip
   {
      ...
      {
         if(!this.bDisableInput && (!this.bDisableSelection || Boolean(this.bAllowSelectionDisabledListNav)))
         {
      ...
      {
         var _loc2_:* = undefined;
         if(!this.bDisableInput && (!this.bDisableSelection || Boolean(this.bAllowSelectionDisabledListNav)) && this.iMaxScrollPosition > 0)
         {
      ...
      public function InvalidateData() : *
      {
         ...
         this.UpdateList();
         if(Boolean(this.restoreListIndex) && !this.needMobileScrollList)
         {
      ...
      public function moveSelectionUp() : *
      {
         ...
         if(!this.bDisableSelection || Boolean(this.bAllowSelectionDisabledListNav))
         {
