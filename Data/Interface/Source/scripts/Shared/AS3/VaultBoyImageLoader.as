package Shared.AS3
{
	...
	public dynamic class VaultBoyImageLoader extends Shared.AS3.BSUIComponent
	{

//		public var VaultBoyImageInternal_mc:Shared.AS3.BSUIComponent;
		...
		public function onMenuLoadComplete(param1:Event, param2:String) : void
		{
			...
			if(Boolean(param1) && Boolean(param1.currentTarget) && Boolean(param1.currentTarget.content))
			{
		...
		{
			if(Boolean(this.bPlayClipOnce) && Boolean(this.SWF) && this.SWF.currentFrame == this.SWF.totalFrames)
			{
