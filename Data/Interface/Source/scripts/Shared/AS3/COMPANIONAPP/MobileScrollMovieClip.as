   ...
   public class MobileScrollMovieClip
   {
      ...
      private function mouseMoveHandler(param1:MouseEvent) : void
      {
         ...
         if(this._mouseDown)
         {
            ...
            if(Boolean(isNaN(_loc2_.x)) || Boolean(isNaN(_loc2_.y)) || _loc2_.y < this._scrollZone.y || _loc2_.y > this._scrollZone.height + this._scrollZone.y || _loc2_.x < this._scrollZone.x || _loc2_.x > this._scrollZone.width + this._scrollZone.x)
            {
