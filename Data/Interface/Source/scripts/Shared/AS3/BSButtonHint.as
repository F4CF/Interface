package Shared.AS3
{
   ...
   public dynamic class BSButtonHint extends BSUIComponent
   {
      ...
      {
         var _loc1_:String = "";
         if(iPlatform != PlatformChangeEvent.PLATFORM_MOBILE && Boolean(this.UsePCKey))
         {
            _loc1_ = this.PCKey;
         }
         else
      ...
      {
         return Boolean(this.ButtonDisabled) && (!this._buttonHintData.hasSecondaryButton || Boolean(this.SecondaryButtonDisabled));
      }
      
      public function get ButtonVisible() : Boolean
      {
         return Boolean(this._buttonHintData) && Boolean(this._buttonHintData.ButtonVisible);
      }
      ...
      {
         if(!this.ButtonDisabled && Boolean(this.ButtonVisible))
         {
