package
{
   ...
   public class WorkshopsTab extends PipboyTab
   {
      ...
      override public function redrawUIComponent() : void
      {
         ...
         this.ShowOnMapButton.ButtonVisible = Boolean(this.visible) && this.List_mc.selectedEntry != null;
      }
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(param1 == "XButton" && Boolean(this.ShowOnMapButton.ButtonVisible) && !param2)
         {
            this.onShowOnMap();
            _loc3_ = true;
         }
