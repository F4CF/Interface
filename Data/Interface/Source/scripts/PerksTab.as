package
{
   ...
   public class PerksTab extends PipboyTab
   {
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!param2)
         {
            if(param1 == "PrevPerk" && Boolean(this.PrevPerkButton.ButtonVisible) && Boolean(this.PrevPerkButton.ButtonEnabled))
            {
               this.onPrevPerk();
               _loc3_ = true;
            }
            else if(param1 == "NextPerk" && Boolean(this.NextPerkButton.ButtonVisible) && Boolean(this.NextPerkButton.ButtonEnabled))
            {
               this.onNextPerk();
               _loc3_ = true;
            }
