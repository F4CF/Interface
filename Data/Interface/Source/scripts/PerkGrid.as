   ...
   public class PerkGrid extends BSUIComponent
   {
               ...
               if(info != null)
               {
                  ...
                  if(starHolder != null && info.displayMaxRank != null && (info.displayMaxRank > 1 || info.displayRank == 1))
                  {
                     ...
                     while(uirank < info.displayMaxRank)
                     {
                        ...
                        if(Boolean(_available) || Boolean(_active))
                        {
      ...
      private function onKeyDown(param1:KeyboardEvent) : *
      {
         ...
         if(!this.bDisableInput && this.iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE)
         {
            ...
            if(param1.keyCode == Keyboard.UP && this.uiCurrSelectRow > 0 && Boolean(this.IsValidEntry(this.uiCurrSelectRow - 1,this.uiCurrSelectCol)))
            {
               this.SetSelectedClip(this.uiCurrSelectRow - 1,this.uiCurrSelectCol);
               param1.stopPropagation();
            }
            else if(param1.keyCode == Keyboard.DOWN && this.uiCurrSelectRow < this.EntriesA.length - 1 && Boolean(this.IsValidEntry(this.uiCurrSelectRow + 1,this.uiCurrSelectCol)))
            {
               this.SetSelectedClip(this.uiCurrSelectRow + 1,this.uiCurrSelectCol);
               param1.stopPropagation();
            }
            else if(param1.keyCode == Keyboard.LEFT && this.uiCurrSelectCol > 0 && Boolean(this.IsValidEntry(this.uiCurrSelectRow,this.uiCurrSelectCol - 1)))
            {
               this.SetSelectedClip(this.uiCurrSelectRow,this.uiCurrSelectCol - 1);
               param1.stopPropagation();
            }
            else if(param1.keyCode == Keyboard.RIGHT && this.uiCurrSelectCol < this.HeaderStarHolders.length - 1 && Boolean(this.IsValidEntry(this.uiCurrSelectRow,this.uiCurrSelectCol + 1)))
            {
               this.SetSelectedClip(this.uiCurrSelectRow,this.uiCurrSelectCol + 1);
               param1.stopPropagation();
            }
