package
{
   ...
   public class ModLibraryPage extends BSUIComponent
   {
      ...
      {
         this.TextScrollUp.visible = Boolean(this.Description_tf.visible) && this.Description_tf.scrollV > 1;
         this.TextScrollDown.visible = Boolean(this.Description_tf.visible) && this.Description_tf.bottomScrollV < this.Description_tf.numLines;
      }
      ...
      public function CheckThumbnailsLoaded() : Boolean
      {
         ...
         var _loc2_:uint = 0;
         while(Boolean(_loc1_) && _loc2_ < this.List_mc.entryList.length)
         {
