package
{
   ...
   public class LevelUpMenu extends IMenu
   {
      ...
      public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!_loc3_)
         {
            if(!param2)
            {
               ...
               else if(param1 == "PrevPerk" && Boolean(this.PrevPerkButton.ButtonVisible) && !this.PrevPerkButton.ButtonDisabled)
               {
                  this.onPrevPerk();
               }
               else if(param1 == "NextPerk" && Boolean(this.NextPerkButton.ButtonVisible) && !this.NextPerkButton.ButtonDisabled)
               {
                  this.onNextPerk();
               }
            }
      ...
      protected function OnSelectPerk() : *
      {
         ...
         if(Boolean(_loc1_.available) && this.uiPerkCount > 0)
         {
      ...
      private function UpdateSelectionText() : *
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_.length >= 2)
            {
               if(this.GridView_mc.selectedPerkEntry.displayRank != this.GridView_mc.selectedPerkEntry.displayMaxRank || Boolean(this._ViewingRanks))
               {
      ...
      private function RefreshStarStates(param1:uint, param2:uint, param3:Boolean) : *
      {
         ...
         while(_loc4_ < param2)
         {
            ...
            _loc6_ = Boolean(param3) && param1 == _loc4_ && this.uiPerkCount > 0;
      ...
      private function SetButtons() : *
      {
         ...
         {
            this.AcceptButton.ButtonDisabled = _loc1_ == null || _loc1_.available == false || Boolean(this._ViewingRanks) && this._ViewingRankOffset != 1;
      ...
      {
         if(Boolean(this.PerkInfo_mc.Confirm_tf.visible) && !this.PerkInfo_mc.Reqs_tf.visible)
         {
            this.ClearErrorText();
         }
