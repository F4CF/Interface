package scaleform.clik.controls
{
   ...
   public class ButtonGroup extends EventDispatcher
   {
      ...
      {
         if(Boolean(param2) && param1 == this.selectedButton)
         {
            return;
         }
         var _loc3_:Boolean = !param2 && param1 == this.selectedButton && Boolean(param1.allowDeselect);
         var _loc4_:scaleform.clik.controls.Button = this.selectedButton;
         if(param2)
         {
            this.selectedButton = param1;
         }
         if(Boolean(param2) && _loc4_ != null)
         {
