package scaleform.clik.managers
{
   ...
   public class FocusHandler
   {
      ...
      public function setFocus(param1:InteractiveObject, param2:uint = 0, param3:Boolean = false) : void
      {
         ...
         if(Boolean(_loc6_) && Boolean(param3) && _loc6_.tabEnabled == false)
         {
            param1 = null;
         }
         if(Boolean(CLIK.disableNullFocusMoves) && (param1 == null || param1 == this._stage))
         {
            return;
         }
         ...
         if(_loc7_ != _loc8_ && (!_loc9_ || Boolean(_loc9_) && !_loc10_))
         {
      ...
      protected function handleInput(param1:InputEvent) : void
      {
         ...
         if(!_loc6_ || Boolean(_loc5_.handled))
         {
            return;
         }
         ...
         if(_loc9_ is TextField && _loc9_ == _loc8_ && Boolean(this.handleTextFieldInput(_loc7_,_loc2_)))
         {
            return;
         }
         if(_loc9_ is TextField && Boolean(this.handleTextFieldInput(_loc7_,_loc2_)))
         {
            return;
         }
         var _loc11_:Boolean = _loc7_ == NavigationCode.LEFT || _loc7_ == NavigationCode.RIGHT;
         var _loc12_:Boolean = _loc7_ == NavigationCode.UP || Boolean(NavigationCode.DOWN);
         if(_loc8_ == null)
         {
            if(Boolean(_loc10_) && _loc10_ is UIComponent)
            {
         ...
         if(_loc8_ == null)
         {
            if(Boolean(_loc9_) && _loc9_ is UIComponent)
            {
      ...
      protected function handleFocusChange(param1:InteractiveObject, param2:InteractiveObject, param3:FocusEvent) : void
      {
         ...
         if(Boolean(this.mouseDown) && param2 is TextField)
         {
            param3.preventDefault();
            return;
         }
         if(Boolean(CLIK.disableDynamicTextFieldFocus) && param2 is TextField)
         {
         ...
         if(param1 is TextField && param2 == null && Boolean(CLIK.disableTextFieldToNullFocusMoves))
         {
            param3.preventDefault();
            return;
         }
      ...
      protected function updateActualFocus(param1:FocusEvent) : void
      {
         ...
         if(_loc3_ != _loc7_)
         {
            if(!(Boolean(_loc8_) && Boolean(_loc9_)) || _loc3_ == null)
            {
               if(!this.preventStageFocusChanges || Boolean(_loc8_))
               {
