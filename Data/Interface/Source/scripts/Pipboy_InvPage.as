package
{
   ...
   public class Pipboy_InvPage extends PipboyPage
   {
      ...
      override protected function onPipboyChangeEvent(param1:PipboyChangeEvent) : void
      {
         ...
         {
            if(Boolean(this._ShowingQuantity) && this._quantityMenuOnItemID != this.List_mc.selectedEntry.nodeID)
            {
               this.HideQuantity();
            }
         }
      ...
      override public function redrawUIComponent() : void
      {
         ...
         this.ModalFadeRect_mc.visible = Boolean(this._ShowingQuantity) || Boolean(this._ShowingFavorites);
      ...
      public function onListSelectionChange() : *
      {
         ...
         if(Boolean(CompanionAppMode.isOn) && this.List_mc.selectedEntry != null)
         {
      ...
      private function SetButtons() : *
      {
         ...
         this.HolotapeButton.ButtonEnabled = !_ReadOnlyMode || Boolean((_ReadOnlyModeType == READ_ONLY_OFFLINE || _ReadOnlyModeType == READ_ONLY_DEMO) && this.List_mc.selectedEntry != null) && Boolean(this.List_mc.selectedEntry.isMinigame);
         ...
         this.FavButton.ButtonVisible = !this._ShowingQuantity && !this._ShowingFavorites && (this._CurrentTab < 3 || this._CurrentTab == 4 && Boolean(this._ComponentViewMode));
         this.FavButton.ButtonEnabled = (!this._ComponentViewMode && this.List_mc.selectedEntry != null && this.List_mc.selectedEntry.canFavorite == true || Boolean(this._ComponentViewMode) && this.ComponentList_mc.selectedEntry != null) && !_ReadOnlyMode;
         this.CycleApparelDamageButton.ButtonVisible = this._CurrentTab == 1 && !this._ShowingQuantity && !this._ShowingFavorites;
         this.AcceptButton.ButtonVisible = Boolean(this._ShowingQuantity) || Boolean(this._ShowingFavorites) && !CompanionAppMode.isOn;
         this.CancelButton.ButtonVisible = Boolean(this._ShowingQuantity) || Boolean(this._ShowingFavorites) && !CompanionAppMode.isOn;
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!_loc3_)
         {
            if(!param2)
            {
               if(this.List_mc.selectedEntry != null)
               {
                  if(param1 == "XButton" && Boolean(this.DropButton.ButtonVisible))
                  {
                     this.DropItem();
                     _loc3_ = true;
                  }
                  else if(param1 == "R3" && Boolean(this.InspectButton.ButtonVisible))
                  {
                     this.ExamineItem();
                     _loc3_ = true;
                  }
                  else if(param1 == "RShoulder" && Boolean(this.FavButton.ButtonVisible) && Boolean(this.FavButton.ButtonEnabled))
                  {
      ...
      {
         return Boolean(super.CanSwitchTabs(param1)) && !this.ModalFadeRect_mc.visible;
      }
