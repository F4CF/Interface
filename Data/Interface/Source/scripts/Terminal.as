package
{
   ...
   public class Terminal extends IMenu
   {
      ...
      {
         if(Boolean(param4) || param1.length + param3 >= param2.length)
         {
      ...
      public function UpdateText(param1:Boolean) : *
      {
         ...
         else
         {
            ...
            if(Boolean(_loc7_) && this.WelcomeText_tf.length < this.strWelcomeText.length)
            {
            ...
            if(Boolean(_loc7_) && Boolean(this.bAnimateDisplayText))
            {
               _loc8_ = 0;
               ...
               while(!_loc9_)
               {
                  ...
                  {
                     _loc10_ = _loc9_;
                     _loc9_ = Boolean(_loc9_) || ++_loc8_ >= _loc5_;
                  }
               }
               if(_loc10_)
               {
      ...
      public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!param2 && Boolean(this.IsTextAnimating()) && (param1 == "Accept" || param1 == "Activate"))
         {
