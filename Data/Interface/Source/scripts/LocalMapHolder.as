...
//====================================================================================================
		...
		{
			MarkerInfoA = e.DataObj.LocalMapMarkers;
			NWCorner = e.DataObj.LocalMapNWCorner;
			NECorner = e.DataObj.LocalMapNECorner;
			SWCorner = e.DataObj.LocalMapSWCorner;
			super.onPipboyChangeEvent(e);
			if(false && Boolean(bCompanionGPSMode))
			{
