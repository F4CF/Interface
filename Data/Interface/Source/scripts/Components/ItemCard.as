   ...
   public class ItemCard extends BSUIComponent
   {
      ...
      override public function redrawUIComponent() : void
      {
         ...
         while(_loc5_ >= 0)
         {
            ...
            {
               _loc2_ = Boolean(_loc2_) || Boolean(ItemCard_MultiEntry.IsEntryValid(this._InfoObj[_loc5_]));
            }
            else if(this._InfoObj[_loc5_].text == ItemCard_MultiEntry.DMG_ARMO_ID)
            {
               _loc3_ = Boolean(_loc3_) || Boolean(ItemCard_MultiEntry.IsEntryValid(this._InfoObj[_loc5_]));
            }
