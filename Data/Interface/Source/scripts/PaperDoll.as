   ...
   public class PaperDoll extends BSUIComponent
   {
      ...
      override public function redrawUIComponent() : void
      {
         ...
         if(this._SelectedInfoObj.length > 0)
         {
            ...
            this.LeftLeg_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_LEFT_LEG]) || this._SlotResists[this.IDX_LEFT_LEG].length > 0;
            ...
            this.RightLeg_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_RIGHT_LEG]) || this._SlotResists[this.IDX_RIGHT_LEG].length > 0;
            ...
            this.LeftArm_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_LEFT_ARM]) || this._SlotResists[this.IDX_LEFT_ARM].length > 0;
            ...
            this.RightArm_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_RIGHT_ARM]) || this._SlotResists[this.IDX_RIGHT_ARM].length > 0;
            ...
            this.Torso_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_TORSO]) || this._SlotResists[this.IDX_TORSO].length > 0;
            ...
            this.Helmet_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_HELMET]) || this._SlotResists[this.IDX_HELMET].length > 0;
            ...
            this.Goggles_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_GOGGLES]) || this._SlotResists[this.IDX_GOGGLES].length > 0;
            ...
            this.GasMask_mc.visible = Boolean(this._SelectedInfoObj[this.IDX_GAS_MASK]) || this._SlotResists[this.IDX_GAS_MASK].length > 0;
            _loc1_ = 0;
