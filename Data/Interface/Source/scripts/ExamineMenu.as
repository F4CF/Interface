package
{
   ...
   public class ExamineMenu extends IMenu
   {
      ...
      {
         if(param1.keyCode == 13 && Boolean(this.bEnteringText))
         {
      ...
      {
         if(this.ModSlotListObject.selectedIndex > -1 && Boolean(this.ModListObject.entryList))
         {
      ...
      {
         if(Boolean(this._isCookingMenu) || this.ModSlotBase_mc.ModSlotList_mc.entryList.length > 0)
         {
      ...
      {
         return !this.GetModEquipped() && (Boolean(this.GetLooseModAvailable()) || Boolean(this.BGSCodeObj.CheckRequirements(param1)));
      }
      ...
      public function UpdateButtons() : *
      {
         ...
         switch(this.eMode)
         {
            case this.INVENTORY_MODE:
               ...
               this.RenameButton.ButtonVisible = !this._allowRepair && Boolean(this._allowRename);
         ...
         if(!this.bEnteringText)
         {
            ...
            if(param2 == false)
            {
               switch(param1)
               {
                  ...
                  case "Left":
                  case "StrafeLeft":
                     if(this.eMode == this.INSPECT_MODE || this.eMode == this.INVENTORY_MODE || this.eMode == this.SLOTS_MODE && Boolean(this._isCookingMenu))
                     {
                        break;
                     }
                  case "Cancel":
      ...
      private function onRenameRepairSearch() : void
      {
         ...
         else if(Boolean(this.allowRename) && !this.enteringText)
         {
            this.enteringText = !this.enteringText;
         }
      }
      ...
      public function UpdateDescription() : *
      {
         ...
         if(this.eMode == this.MOD_MODE || this.eMode == this.REQUIREMENTS_MODE)
         {
            if(this._isCookingMenu)
            {
               if(Boolean(this.ModListObject.selectedIndex < this.ModListObject.entryList.length) && Boolean(this.ModListObject.entryList[this.ModListObject.selectedIndex]) && this.ModListObject.entryList[this.ModListObject.selectedIndex].description != undefined)
               {
                  _loc1_ = this.ModListObject.entryList[this.ModListObject.selectedIndex].description;
               }
            }
            else if(Boolean(this.InventoryBase_mc.InventoryList_mc.selectedIndex < this.InventoryBase_mc.InventoryList_mc.entryList.length) && Boolean(this.InventoryBase_mc.InventoryList_mc.entryList[this.InventoryBase_mc.InventoryList_mc.selectedIndex]) && this.InventoryBase_mc.InventoryList_mc.entryList[this.InventoryBase_mc.InventoryList_mc.selectedIndex].description != undefined)
            {
