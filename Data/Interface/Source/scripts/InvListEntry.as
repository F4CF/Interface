package
{
   ...
   public class InvListEntry extends BSScrollingListEntry
   {
      ...
      override public function SetEntryText(param1:Object, param2:String) : *
      {
         ...
         if(this.LegendaryIcon_mc != null && Boolean(this.LegendaryIcon_mc.visible))
         {
         ...
         if(this.FavIcon_mc != null && Boolean(this.FavIcon_mc.visible))
         {
            this.FavIcon_mc.x = _loc5_;
            _loc5_ = _loc5_ + (this.FavIcon_mc.width / 2 + 10);
            this.FavIcon_mc.transform.colorTransform = _loc6_;
         }
         if(this.SearchIcon_mc != null && Boolean(this.SearchIcon_mc.visible))
         {
