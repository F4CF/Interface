package
{
   ...
   public class StatusTab extends PipboyTab
   {
      ...
      override protected function onPipboyChangeEvent(param1:PipboyChangeEvent) : void
      {
         ...
         this.ActiveEffectsButton.ButtonVisible = Boolean(this.visible) && param1.DataObj.ActiveEffects.length > 0;
         if(Boolean(this._ShowingActiveEffects) && param1.DataObj.ActiveEffects.length == 0)
         {
      ...
      override public function ProcessUserEvent(param1:String, param2:Boolean) : Boolean
      {
         ...
         if(!param2)
         {
            if(param1 == "Accept" && this.iPlatform != PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && Boolean(this.StimpakButton.ButtonVisible) && Boolean(this.StimpakButton.ButtonEnabled))
            {
               this.UseStimpak();
               _loc3_ = true;
            }
            else if(param1 == "XButton" && Boolean(this.RadawayButton.ButtonVisible) && Boolean(this.RadawayButton.ButtonEnabled))
            {
               this.UseRadaway();
               _loc3_ = true;
            }
            else if(param1 == "RShoulder" && Boolean(this.ActiveEffectsButton.ButtonVisible) && Boolean(this.ActiveEffectsButton.ButtonEnabled))
            {
               this.ToggleShowingEffects();
               _loc3_ = true;
            }
      ...
      {
         if(param1.keyCode == Keyboard.E && this.iPlatform == PlatformChangeEvent.PLATFORM_PC_KB_MOUSE && Boolean(this.StimpakButton.ButtonVisible) && Boolean(this.StimpakButton.ButtonEnabled))
         {
            this.UseStimpak();
      ...
      private function onStatusTabKeyDown(param1:KeyboardEvent) : *
      {
         ...
         if(Boolean(this._ShowingActiveEffects) && Boolean(this.visible) && this._ActiveEffect_ScrollDist != 0)
         {
