package bhvr.controller
{
	...
	public class GameController
	{
		...
		private function initialize() : void
		{
			...
			SoundManager.instance.registerSound(SoundList.MOTHERSHIP_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.TRACTOR_BEAM_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.GAME_MUSIC_LOOP_SOUND);
			SoundManager.instance.registerSound(SoundList.MAIN_MENU_MUSIC_LOOP_SOUND);
