package bhvr.states
{
	...
	public class GameState extends EventDispatcher
	{
		...
		public function enter(obj:Object = null) : void
		{
			if(this.BGSCodeObj && this.BGSCodeObj.playActionAnim)
			{
				...
				InputManager.instance.addEventListener(GameInputs.MOVE_UP,this.onPushRight);
				InputManager.instance.addEventListener(GameInputs.MOVE_DOWN,this.onPushLeft);
		...
		public function exit() : void
		{
			...
			if(this.BGSCodeObj && this.BGSCodeObj.playActionAnim)
			{
				...
				InputManager.instance.removeEventListener(GameInputs.MOVE_UP,this.onPushRight);
				InputManager.instance.removeEventListener(GameInputs.MOVE_DOWN,this.onPushLeft);
		...
		private function onStopMove(e:EventWithParams) : void
		{
			this._animPlayedLeft = false;
			this._animPlayedRight = false;
		}
		...
		{
			Log.info("[" + getQualifiedClassName(this) + "] " + message);
		}
		
		protected function logWarning(message:String) : void
		{
			Log.warn("[" + getQualifiedClassName(this) + "] " + message);
		}
